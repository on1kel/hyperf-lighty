...
abstract class BaseGenerator extends BaseCommand
{
    ...
    /**
     * @return array{namespace:string,dir:string,name:string,path:string,dir_path:string}
     */
    public function getMetaFromClassName(
        string $name,
        false|string $default_generator_namespace = false,
        false|string $default_generator_dir = false
    ): array {
        $result = [
