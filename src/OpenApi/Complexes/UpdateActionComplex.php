...
use On1kel\HyperfLighty\OpenApi\Complexes\UpdateAction\UpdateActionArgumentsDTO;
use On1kel\OAS\Builder\Responses\Responses;
use ReflectionException;
use Spatie\DataTransferObject\Exceptions\UnknownProperties;

final class UpdateActionComplex implements ComplexFactoryInterface
{
    ...
    {
        $args = new UpdateActionArgumentsDTO($arguments);
